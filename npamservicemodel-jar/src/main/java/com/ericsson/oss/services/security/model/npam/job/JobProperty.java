...
@EModel(namespace = NPamModelsConstants.NAME_SPACE, name = "JobProperty", version = NPamModelsConstants.VERSION, description = "Key and Value of Job Property")
@CdtDefinition
public class JobProperty {

	@EModelAttribute(description = "Key")
	@CdtAttribute
	public String key;
