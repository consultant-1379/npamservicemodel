...
@EModel(namespace = NPamModelsConstants.NAME_SPACE, name = "Step", version = NPamModelsConstants.VERSION, description = "Execution Steps (internal use only)")
@EdtDefinition
public enum Step {
	
	@EdtMember(value = 1, description = "no step")
	NONE,
	
	@EdtMember(value = 2, description = "wait for event")
	WFE
}
