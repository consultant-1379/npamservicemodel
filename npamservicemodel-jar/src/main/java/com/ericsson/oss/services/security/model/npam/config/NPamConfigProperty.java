...
@EModel(namespace = NPamModelsConstants.NAME_SPACE, name = "NPamConfigProperty", version = NPamModelsConstants.VERSION, description = "Name and Values of NPamConfig Property")
@CdtDefinition
public class NPamConfigProperty {
